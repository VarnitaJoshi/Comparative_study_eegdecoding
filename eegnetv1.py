...
log_file_path = "./output/eegnetv1/training_log2.txt"
...
# early_stopping = EarlyStopping(patience = 40, monitor = 'valid_loss', lower_is_better = True,  threshold=0.0001)
...
plt.tight_layout()
plt.savefig('./output/eegnetv1/Lossgraph2.png')
...
fig.savefig('./output/eegnetv1/confusion_mat2.png')

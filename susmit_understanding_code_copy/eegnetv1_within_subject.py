...
for subject in subject_id:
    ...
    # log_file_path = "./output/eegnetv1/training_log_eegnetv1try_exp.txt"
    log_file_path = f"./output/eegnetv1_within_subject/training_log_subject_{subject}.txt"
    ...
    plt.tight_layout()
    # plt.savefig('./output/eegnetv1/Lossgraph2_exp.png')
    plt.savefig(f'./output/eegnetv1_within_subject/Lossgraph_subject_{subject}.png')
    ...
    # fig.savefig('./output/eegnetv1/confusion_mat2_exp.png')
    fig.savefig(f'./output/eegnetv1_within_subject/confusion_mat_subject{subject}.png')

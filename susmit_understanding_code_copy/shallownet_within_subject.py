...
for subject in subject_id:
    ...
    model = ShallowFBCSPNet(
        ...
        final_conv_length = 'auto', drop_prob = 0.6, n_filters_time = 40, n_filters_spat=40, 
    ...
    # log_file_path = "./output/shallownet/training_log_shallowtry_exp.txt"
    log_file_path = f"./output/shallownet_within_subject/training_log_subject_{subject}.txt"
    ...
    early_stopping = EarlyStopping(patience = 18, monitor = 'valid_loss', lower_is_better = True,  threshold=0.00001)
    ...
    plt.tight_layout()
    # plt.savefig('./output/shallownet/Lossgraph2_shallowexp.png')
    plt.savefig(f'./output/shallownet_within_subject/Lossgraph_subject_{subject}.png')
    ...
    # fig.savefig('./output/shallownet/confusion_mat2_shallowexp.png')
    fig.savefig(f'./output/shallownet_within_subject/confusion_mat_subject{subject}.png')

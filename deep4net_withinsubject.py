...
for subject in subject_id:
    ...
    model = Deep4Net(
        n_chans,
        n_classes,
        input_window_samples = input_window_samples, drop_prob = 0.6, n_filters_time = 20, n_filters_spat = 20, 
    n_filters_2 = 20, n_filters_3 = 40, n_filters_4 = 80
    )
    ...
    # log_file_path = "./output/deep4net/training_log_deep4_dataaug.txt"
    log_file_path = f"./output/deep4net_within_subject/training_log_subject_{subject}.txt"
    ...
    plt.tight_layout()
    # plt.savefig('./output/deep4net/Lossgraph2_deep4exp_dataaug.png')
    plt.savefig(f'./output/deep4net_within_subject/Lossgraph_subject_{subject}.png')
    ...
    # fig.savefig('./output/deep4net/confusion_mat2_deep4exp_dataaug.png')
    fig.savefig(f'./output/deep4net_within_subject/confusion_mat_subject{subject}.png')
